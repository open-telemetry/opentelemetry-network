...
int main(int argc, char *argv[])
{
  ...
  LOG::info(
    "Kubernetes Collector version {} ({}) started on host {}",
  ...
  collector::ResyncProcessor processor{
    loop, &queue, channel, configuration_data,
    hostname, authz_fetcher,
