...
{
  LOG::debug_in(AgentLogKind::PROTOCOL,"ProtocolHandler_UNKNOWN::$ctor(sk={:x})", 
    control_key().sk);
...
{
  LOG::debug_in(AgentLogKind::PROTOCOL,"ProtocolHandler_UNKNOWN::$dtor(sk={:x})", 
    control_key().sk);
}

void ProtocolHandler_UNKNOWN::handle_server_data(u64 tstamp, u64 offset, STREAM_TYPE stream_type, const u8 *data, size_t data_len)
{
  LOG::debug_in(AgentLogKind::PROTOCOL,"ProtocolHandler_UNKNOWN::handle_server_data(sk={:x}): tstamp={}, offset={}, is_recv={}, data_len={}, data={}", 
...
TCP_PROTOCOL_DETECT_RESULT ProtocolHandler_UNKNOWN::detect_http(u64 offset, STREAM_TYPE stream_type, const u8 *data, size_t data_len)
{
...
void ProtocolHandler_UNKNOWN::handle_client_data(u64 tstamp, u64 offset, STREAM_TYPE stream_type, const u8 *data, size_t data_len)
{
  LOG::debug_in(AgentLogKind::PROTOCOL,"ProtocolHandler_UNKNOWN::handle_client_data(sk={:x}): tstamp={}, offset={}, is_recv={}, data_len={}, data:\n{}", 
    tstamp, control_key().sk, offset, stream_type_to_string(stream_type), data_len, std::string_view((const char *)data, data_len));
