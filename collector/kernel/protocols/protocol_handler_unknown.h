...
public:
    ...
    virtual void handle_server_data(u64 tstamp, u64 offset, STREAM_TYPE stream_type,
        const u8 *data, size_t data_len) override;
    virtual void handle_client_data(u64 tstamp, u64 offset, STREAM_TYPE stream_type,
        const u8 *data, size_t data_len) override;

protected:
    typedef TCP_PROTOCOL_DETECT_RESULT (ProtocolHandler_UNKNOWN::*PROTOCOL_DETECT_FUNC)(u64 offset, STREAM_TYPE stream_type, const u8 *data, size_t data_len);
