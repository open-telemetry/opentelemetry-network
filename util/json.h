...
std::string const *try_get_string(nlohmann::json const &object, Path &&...path) {
...
// empty if not found
template <typename... Path>
std::string_view get_string_view(nlohmann::json const &object, Path &&...path) {
...
// empty if not found
template <typename... Path>
std::string_view get_zstring_view(nlohmann::json const &object, Path &&...path) {
  if (auto const value = try_get_string(object, std::forward<Path>(path)...)) {
...
template <typename... Path>
std::optional<std::int64_t> try_get_as_int(nlohmann::json const &object, Path &&...path) {
