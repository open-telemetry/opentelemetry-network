...
Out &operator <<(Out &&out, std::errc error_code) {
  out << std::strerror(static_cast<int>(error_code));
  return out;
}

template <typename Out>
Out &operator <<(Out &&out, std::error_code error) {
...
template <typename Out>
Out &operator <<(Out &&out, std::exception const &e) {
  out << e.what();
  return out;
}
...
template <typename Out>
Out &operator <<(Out &&out, std::chrono::hours value) {
  out << value.count() << "h";
  return out;
}
template <typename Out>
Out &operator <<(Out &&out, std::chrono::minutes value) {
  out << value.count() << "min";
  return out;
}

template <typename Out>
Out &operator <<(Out &&out, std::chrono::seconds value) {
  out << value.count() << "s";
  return out;
}

template <typename Out>
Out &operator <<(Out &&out, std::chrono::milliseconds value) {
  out << value.count() << "ms";
  return out;
}

template <typename Out>
Out &operator <<(Out &&out, std::chrono::microseconds value) {
  out << value.count() << "\u00B5s";
  return out;
}

template <typename Out>
Out &operator <<(Out &&out, std::chrono::nanoseconds value) {
  out << value.count() << "ns";
  return out;
}
