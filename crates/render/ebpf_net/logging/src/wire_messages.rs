...
#[allow(dead_code)]
  ...
  mod rewriting_private_to_public_ip_mapping_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (REWRITING_PRIVATE_TO_PUBLIC_IP_MAPPING_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__rewriting_private_to_public_ip_mapping, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__rewriting_private_to_public_ip_mapping, _len), 2);
      assert_eq!(offset_of!(jb_logging__rewriting_private_to_public_ip_mapping, private_addr), 4usize);
      assert_eq!(offset_of!(jb_logging__rewriting_private_to_public_ip_mapping, existing_public_addr), 6usize);
      assert_eq!(offset_of!(jb_logging__rewriting_private_to_public_ip_mapping, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod private_ip_in_private_to_public_ip_mapping_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (PRIVATE_IP_IN_PRIVATE_TO_PUBLIC_IP_MAPPING_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__private_ip_in_private_to_public_ip_mapping, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__private_ip_in_private_to_public_ip_mapping, _len), 2);
      assert_eq!(offset_of!(jb_logging__private_ip_in_private_to_public_ip_mapping, private_addr), 4usize);
      assert_eq!(offset_of!(jb_logging__private_ip_in_private_to_public_ip_mapping, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod failed_to_insert_dns_record_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__failed_to_insert_dns_record, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__failed_to_insert_dns_record, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod tcp_socket_failed_getting_process_reference_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (TCP_SOCKET_FAILED_GETTING_PROCESS_REFERENCE_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__tcp_socket_failed_getting_process_reference, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__tcp_socket_failed_getting_process_reference, pid), 4usize);
      assert_eq!(offset_of!(jb_logging__tcp_socket_failed_getting_process_reference, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod udp_socket_failed_getting_process_reference_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (UDP_SOCKET_FAILED_GETTING_PROCESS_REFERENCE_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__udp_socket_failed_getting_process_reference, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__udp_socket_failed_getting_process_reference, pid), 4usize);
      assert_eq!(offset_of!(jb_logging__udp_socket_failed_getting_process_reference, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod socket_address_already_assigned_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (SOCKET_ADDRESS_ALREADY_ASSIGNED_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__socket_address_already_assigned, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__socket_address_already_assigned, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod ingest_decompression_error_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__ingest_decompression_error, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__ingest_decompression_error, _len), 2);
      assert_eq!(offset_of!(jb_logging__ingest_decompression_error, client_hostname), 4usize);
      assert_eq!(offset_of!(jb_logging__ingest_decompression_error, client_type), 6usize);
      assert_eq!(offset_of!(jb_logging__ingest_decompression_error, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod ingest_processing_error_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__ingest_processing_error, client_hostname), 4usize);
      assert_eq!(offset_of!(jb_logging__ingest_processing_error, client_type), 6usize);
      assert_eq!(offset_of!(jb_logging__ingest_processing_error, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod ingest_connection_error_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__ingest_connection_error, client_hostname), 4usize);
      assert_eq!(offset_of!(jb_logging__ingest_connection_error, client_type), 6usize);
      assert_eq!(offset_of!(jb_logging__ingest_connection_error, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod agent_auth_success_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__agent_auth_success, client_type), 4usize);
  ...
  mod agent_auth_failure_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__agent_auth_failure, client_hostname), 4usize);
      assert_eq!(offset_of!(jb_logging__agent_auth_failure, client_type), 6usize);
  ...
  mod agent_attempting_auth_using_api_key_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (AGENT_ATTEMPTING_AUTH_USING_API_KEY_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__agent_attempting_auth_using_api_key, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__agent_attempting_auth_using_api_key, _len), 2);
      assert_eq!(offset_of!(jb_logging__agent_attempting_auth_using_api_key, client_type), 4usize);
      assert_eq!(offset_of!(jb_logging__agent_attempting_auth_using_api_key, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod k8s_container_pod_not_found_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__k8s_container_pod_not_found, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__k8s_container_pod_not_found, pod_uid_suffix), 2usize);
      assert_eq!(offset_of!(jb_logging__k8s_container_pod_not_found, pod_uid_hash), 72usize);
      assert_eq!(offset_of!(jb_logging__k8s_container_pod_not_found, _ref), 80usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod agent_connect_success_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__agent_connect_success, client_type), 4usize);
  ...
  mod span_utilization_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__span_utilization_stats, span_name), 4usize);
      assert_eq!(offset_of!(jb_logging__span_utilization_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__span_utilization_stats, time_ns), 8usize);
      assert_eq!(offset_of!(jb_logging__span_utilization_stats, _ref), 16usize);
      assert_eq!(offset_of!(jb_logging__span_utilization_stats, allocated), 24usize);
      assert_eq!(offset_of!(jb_logging__span_utilization_stats, max_allocated), 26usize);
      assert_eq!(offset_of!(jb_logging__span_utilization_stats, pool_size_), 28usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod connection_message_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__connection_message_stats, severity_), 4usize);
      assert_eq!(offset_of!(jb_logging__connection_message_stats, time_ns), 8usize);
      assert_eq!(offset_of!(jb_logging__connection_message_stats, count), 16usize);
      assert_eq!(offset_of!(jb_logging__connection_message_stats, _ref), 24usize);
      assert_eq!(offset_of!(jb_logging__connection_message_stats, module), 32usize);
      assert_eq!(offset_of!(jb_logging__connection_message_stats, shard), 34usize);
      assert_eq!(offset_of!(jb_logging__connection_message_stats, conn), 36usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod connection_message_error_stats_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (CONNECTION_MESSAGE_ERROR_STATS_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, _len), 2);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, module), 4usize);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, count), 8usize);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, time_ns), 16usize);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, _ref), 24usize);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, conn), 32usize);
      assert_eq!(offset_of!(jb_logging__connection_message_error_stats, msg_), 34usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod rpc_receive_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__rpc_receive_stats, receiver_app), 4usize);
      assert_eq!(offset_of!(jb_logging__rpc_receive_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__rpc_receive_stats, max_latency_ns), 8usize);
  ...
  mod rpc_write_stalls_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__rpc_write_stalls_stats, sender_app), 4usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_stalls_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_stalls_stats, count), 8usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_stalls_stats, time_ns), 16usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_stalls_stats, _ref), 24usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod rpc_write_utilization_stats_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, _len), 2);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, max_buf_used), 4usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, max_buf_util), 8usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, max_elem_util), 16usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, time_ns), 24usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, _ref), 32usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, sender_app), 40usize);
      assert_eq!(offset_of!(jb_logging__rpc_write_utilization_stats, shard), 42usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod code_timing_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__code_timing_stats, index_string), 8usize);
  ...
  mod agg_root_truncation_stats_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__agg_root_truncation_stats, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__agg_root_truncation_stats, _len), 2);
      assert_eq!(offset_of!(jb_logging__agg_root_truncation_stats, module), 4usize);
      assert_eq!(offset_of!(jb_logging__agg_root_truncation_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__agg_root_truncation_stats, count), 8usize);
      assert_eq!(offset_of!(jb_logging__agg_root_truncation_stats, time_ns), 16usize);
      assert_eq!(offset_of!(jb_logging__agg_root_truncation_stats, _ref), 24usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod agg_prometheus_bytes_stats_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__agg_prometheus_bytes_stats, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__agg_prometheus_bytes_stats, _len), 2);
      assert_eq!(offset_of!(jb_logging__agg_prometheus_bytes_stats, shard), 4usize);
      assert_eq!(offset_of!(jb_logging__agg_prometheus_bytes_stats, prometheus_bytes_written), 8usize);
      assert_eq!(offset_of!(jb_logging__agg_prometheus_bytes_stats, prometheus_bytes_discarded), 16usize);
      assert_eq!(offset_of!(jb_logging__agg_prometheus_bytes_stats, time_ns), 24usize);
      assert_eq!(offset_of!(jb_logging__agg_prometheus_bytes_stats, _ref), 32usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod agg_otlp_grpc_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, bytes_failed), 8usize);
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, bytes_sent), 16usize);
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, data_points_failed), 24usize);
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, data_points_sent), 32usize);
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, requests_failed), 40usize);
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, requests_sent), 48usize);
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, unknown_response_tags), 56usize);
      assert_eq!(offset_of!(jb_logging__agg_otlp_grpc_stats, time_ns), 64usize);
  ...
  mod ingest_core_stats_start_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__ingest_core_stats_start, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod client_handle_pool_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, module), 4usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, time_ns), 8usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, client_handle_pool), 16usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, client_handle_pool_fraction), 24usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, _ref), 32usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, span_name), 40usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, version), 42usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, cloud), 44usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, env), 46usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, role), 48usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, az), 50usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, node_id), 52usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, kernel_version), 54usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, client_type), 56usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, agent_hostname), 58usize);
      assert_eq!(offset_of!(jb_logging__client_handle_pool_stats, os), 60usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod agent_connection_message_stats_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (AGENT_CONNECTION_MESSAGE_STATS_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, _len), 2);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, module), 4usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, time_ns), 8usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, count), 16usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, _ref), 24usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, version), 32usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, cloud), 34usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, env), 36usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, role), 38usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, az), 40usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, node_id), 42usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, kernel_version), 44usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, client_type), 46usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, agent_hostname), 48usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, os), 50usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, os_version), 52usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_stats, severity_), 54usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod agent_connection_message_error_stats_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (AGENT_CONNECTION_MESSAGE_ERROR_STATS_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, _rpc_id), 0);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, _len), 2);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, module), 4usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, time_ns), 8usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, count), 16usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, _ref), 24usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, version), 32usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, cloud), 34usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, env), 36usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, role), 38usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, az), 40usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, node_id), 42usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, kernel_version), 44usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, client_type), 46usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, agent_hostname), 48usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, os), 50usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, os_version), 52usize);
      assert_eq!(offset_of!(jb_logging__agent_connection_message_error_stats, message), 54usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod connection_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__connection_stats, time_since_last_message_ns), 16usize);
      assert_eq!(offset_of!(jb_logging__connection_stats, clock_offset_ns), 24usize);
      ...
      assert_eq!(offset_of!(jb_logging__connection_stats, kernel_version), 52usize);
      assert_eq!(offset_of!(jb_logging__connection_stats, client_type), 54usize);
      assert_eq!(offset_of!(jb_logging__connection_stats, agent_hostname), 56usize);
  ...
  mod collector_log_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__collector_log_stats, version), 28usize);
      ...
      assert_eq!(offset_of!(jb_logging__collector_log_stats, node_id), 38usize);
      assert_eq!(offset_of!(jb_logging__collector_log_stats, kernel_version), 40usize);
      assert_eq!(offset_of!(jb_logging__collector_log_stats, client_type), 42usize);
      assert_eq!(offset_of!(jb_logging__collector_log_stats, agent_hostname), 44usize);
      assert_eq!(offset_of!(jb_logging__collector_log_stats, os), 46usize);
      assert_eq!(offset_of!(jb_logging__collector_log_stats, os_version), 48usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod entry_point_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__entry_point_stats, kernel_version), 36usize);
      assert_eq!(offset_of!(jb_logging__entry_point_stats, client_type), 38usize);
      assert_eq!(offset_of!(jb_logging__entry_point_stats, agent_hostname), 40usize);
      assert_eq!(offset_of!(jb_logging__entry_point_stats, os), 42usize);
      assert_eq!(offset_of!(jb_logging__entry_point_stats, os_version), 44usize);
      assert_eq!(offset_of!(jb_logging__entry_point_stats, kernel_headers_source), 46usize);
      assert_eq!(offset_of!(jb_logging__entry_point_stats, entrypoint_info), 48usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod collector_health_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__collector_health_stats, module), 4usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, shard), 6usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, time_ns), 8usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, _ref), 16usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, version), 24usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, cloud), 26usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, env), 28usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, role), 30usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, az), 32usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, node_id), 34usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, kernel_version), 36usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, client_type), 38usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, hostname), 40usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, os), 42usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, os_version), 44usize);
      assert_eq!(offset_of!(jb_logging__collector_health_stats, status), 46usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod bpf_log_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__bpf_log_stats, kernel_version), 36usize);
  ...
  mod server_stats_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_logging__server_stats, connection_counter), 8usize);
      assert_eq!(offset_of!(jb_logging__server_stats, disconnect_counter), 16usize);
