...
#[allow(dead_code)]
  ...
  mod http_update_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_matching__http_update, sum_total_time_ns), 8usize);
      assert_eq!(offset_of!(jb_matching__http_update, sum_processing_time_ns), 16usize);
      ...
      assert_eq!(offset_of!(jb_matching__http_update, sum_code_other), 44usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod dns_update_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_matching__dns_update, sum_total_time_ns), 8usize);
      assert_eq!(offset_of!(jb_matching__dns_update, sum_processing_time_ns), 16usize);
  ...
  mod k8s_container_start_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_matching__k8s_container_start, uid_suffix), 2usize);
      assert_eq!(offset_of!(jb_matching__k8s_container_start, uid_hash), 72usize);
  ...
  mod set_container_pod_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_matching__set_container_pod, pod_uid_suffix), 6usize);
      assert_eq!(offset_of!(jb_matching__set_container_pod, pod_uid_hash), 72usize);
