...
#[allow(dead_code)]
  ...
  mod pid_info_create_deprecated_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__pid_info_create_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__pid_info_create_deprecated, comm), 2usize);
      assert_eq!(offset_of!(jb_ingest__pid_info_create_deprecated, pid), 20usize);
      assert_eq!(offset_of!(jb_ingest__pid_info_create_deprecated, cgroup), 24usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod cgroup_create_deprecated_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__cgroup_create_deprecated, name), 2usize);
      assert_eq!(offset_of!(jb_ingest__cgroup_create_deprecated, cgroup), 72usize);
      assert_eq!(offset_of!(jb_ingest__cgroup_create_deprecated, cgroup_parent), 80usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod cgroup_create_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__cgroup_create, cgroup_parent), 272usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod container_metadata_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__container_metadata, container_name), 22usize);
      assert_eq!(offset_of!(jb_ingest__container_metadata, task_family), 24usize);
      assert_eq!(offset_of!(jb_ingest__container_metadata, task_version), 26usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod container_resource_limits_deprecated_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (CONTAINER_RESOURCE_LIMITS_DEPRECATED_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, cpu_shares), 2usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, cpu_period), 4usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, cpu_quota), 6usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, cgroup), 8usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, memory_limit), 16usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, memory_soft_limit), 24usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, total_memory_limit), 32usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits_deprecated, memory_swappiness), 40usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod container_resource_limits_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, cpu_shares), 2usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, cpu_period), 4usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, cgroup), 8usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, memory_limit), 16usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, memory_soft_limit), 24usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, total_memory_limit), 32usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, cpu_quota), 40usize);
      assert_eq!(offset_of!(jb_ingest__container_resource_limits, memory_swappiness), 44usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod set_availability_zone_deprecated_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (SET_AVAILABILITY_ZONE_DEPRECATED_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__set_availability_zone_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__set_availability_zone_deprecated, retcode), 2usize);
      assert_eq!(offset_of!(jb_ingest__set_availability_zone_deprecated, az), 3usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod set_iam_role_deprecated_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__set_iam_role_deprecated, retcode), 2usize);
  ...
  mod set_instance_id_deprecated_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__set_instance_id_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__set_instance_id_deprecated, retcode), 2usize);
      assert_eq!(offset_of!(jb_ingest__set_instance_id_deprecated, id), 3usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod set_instance_type_deprecated_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__set_instance_type_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__set_instance_type_deprecated, retcode), 2usize);
      assert_eq!(offset_of!(jb_ingest__set_instance_type_deprecated, val), 3usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod dns_response_fake_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__dns_response_fake, total_dn_len), 4usize);
  ...
  mod dns_response_dep_a_deprecated_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_a_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_a_deprecated, _len), 2);
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_a_deprecated, total_dn_len), 4usize);
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_a_deprecated, domain_name), 6usize);
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_a_deprecated, ipv4_addrs), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod set_config_label_deprecated_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__set_config_label_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__set_config_label_deprecated, key), 2usize);
      assert_eq!(offset_of!(jb_ingest__set_config_label_deprecated, val), 22usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod public_to_private_ipv4_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__public_to_private_ipv4, vpc_id), 2usize);
      assert_eq!(offset_of!(jb_ingest__public_to_private_ipv4, public_addr), 24usize);
      assert_eq!(offset_of!(jb_ingest__public_to_private_ipv4, private_addr), 28usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod pod_new_legacy_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__pod_new_legacy, is_host_network), 15usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod pod_new_legacy2_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__pod_new_legacy2, is_host_network), 17usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod pod_new_with_name_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__pod_new_with_name, owner_name), 10usize);
      ...
      assert_eq!(offset_of!(jb_ingest__pod_new_with_name, owner_kind), 18usize);
      assert_eq!(offset_of!(jb_ingest__pod_new_with_name, is_host_network), 19usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod agent_resource_usage_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, cpu_usage_by_agent), 2usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, minor_page_faults), 4usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, user_mode_time_us), 8usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, kernel_mode_time_us), 16usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, max_resident_set_size), 24usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, major_page_faults), 32usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, block_input_count), 36usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, block_output_count), 40usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, voluntary_context_switch_count), 44usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, involuntary_context_switch_count), 48usize);
      assert_eq!(offset_of!(jb_ingest__agent_resource_usage, cpu_idle), 52usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod cloud_platform_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__cloud_platform, cloud_platform), 2usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod cloud_platform_account_info_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__cloud_platform_account_info, _rpc_id), 0);
  ...
  mod system_wide_process_settings_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__system_wide_process_settings, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__system_wide_process_settings, clock_ticks_per_second), 8usize);
      assert_eq!(offset_of!(jb_ingest__system_wide_process_settings, memory_page_bytes), 16usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod report_cpu_cores_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__report_cpu_cores, cpu_core_count), 4usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod aws_network_interface_start_layout_tests {
    ...
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__aws_network_interface_start, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__aws_network_interface_start, _ref), 8usize);
      assert_eq!(offset_of!(jb_ingest__aws_network_interface_start, ip), 16usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod aws_network_interface_end_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__aws_network_interface_end, _ref), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod network_interface_info_deprecated_layout_tests {
    ...
    fn struct_size() {
      ...
      let padded_raw_size = (NETWORK_INTERFACE_INFO_DEPRECATED_WIRE_SIZE + align - 1) / align * align;
      assert_eq!(size, padded_raw_size);
    }
    #[test]
    fn field_offsets() {
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, _rpc_id), 0);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, _len), 2);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, interface_id), 4usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, interface_type), 6usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, _ref), 8usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, instance_id), 16usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, instance_owner_id), 18usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, public_dns_name), 20usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, private_dns_name), 22usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, ip_owner_id), 24usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, vpc_id), 42usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info_deprecated, az), 64usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod network_interface_info_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__network_interface_info, ip_owner_id), 4usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info, vpc_id), 6usize);
      ...
      assert_eq!(offset_of!(jb_ingest__network_interface_info, interface_id), 18usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info, interface_type), 20usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info, instance_id), 22usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info, instance_owner_id), 24usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info, public_dns_name), 26usize);
      assert_eq!(offset_of!(jb_ingest__network_interface_info, private_dns_name), 28usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod udp_stats_addr_unchanged_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_unchanged, is_rx), 2usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_unchanged, sk_id), 4usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_unchanged, packets), 8usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_unchanged, bytes), 12usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod udp_stats_addr_changed_v4_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v4, rport), 2usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v4, sk_id), 4usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v4, packets), 8usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v4, bytes), 12usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v4, raddr), 16usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v4, is_rx), 20usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod udp_stats_addr_changed_v6_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v6, rport), 2usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v6, sk_id), 4usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v6, packets), 8usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v6, bytes), 12usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v6, is_rx), 16usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_addr_changed_v6, raddr), 17usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod dns_response_dep_b_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_b, latency_ns), 8usize);
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_b, total_dn_len), 16usize);
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_b, domain_name), 18usize);
      assert_eq!(offset_of!(jb_ingest__dns_response_dep_b, ipv4_addrs), 20usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
  ...
  mod udp_stats_drops_changed_layout_tests {
    ...
    fn field_offsets() {
      ...
      assert_eq!(offset_of!(jb_ingest__udp_stats_drops_changed, sk_id), 4usize);
      assert_eq!(offset_of!(jb_ingest__udp_stats_drops_changed, drops), 8usize);
    }
  }
  #[repr(C)]
  #[derive(Copy, Clone)]
